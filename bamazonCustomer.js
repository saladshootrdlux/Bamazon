...
// Function which checks to make sure data cannot be input if it is negative integers or zeros
	...
	inquirer.prompt([
		{
			type: 'input',
			name: 'item_id',
			message: 'Please input the Item ID number which you would like to purchase.',
		...
		},
		{
			type: 'input',
			name: 'quantity',
			message: 'What quantity will you be needing today?',
			validate: validateInput,
			filter: Number
		}
	]).then(function(input) {
